...
public class AsymmetricCipherExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(DatatypeConverter.printHexBinary(clearText));
        ...
        System.out.println(DatatypeConverter.printHexBinary(decryptedText));
        final String decryptedTextAsString = new String(decryptedText, "UTF-8");
        System.out.println("Decrypted text: " + decryptedTextAsString);
    }
}
